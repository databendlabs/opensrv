...
fn p2mt(t: &postgres::types::Type) -> opensrv_mysql::ColumnType {
    if let postgres::types::Kind::Simple = *t.kind() {
        match postgres::types::Type::from_oid(t.oid()) {
            Some(postgres::types::Type::INT2) => opensrv_mysql::ColumnType::MYSQL_TYPE_SHORT,
            Some(postgres::types::Type::INT4) => opensrv_mysql::ColumnType::MYSQL_TYPE_LONG,
            Some(postgres::types::Type::INT8) => opensrv_mysql::ColumnType::MYSQL_TYPE_LONGLONG,
            Some(postgres::types::Type::FLOAT4) => opensrv_mysql::ColumnType::MYSQL_TYPE_FLOAT,
            Some(postgres::types::Type::FLOAT8) => opensrv_mysql::ColumnType::MYSQL_TYPE_DOUBLE,
            Some(postgres::types::Type::TEXT) => opensrv_mysql::ColumnType::MYSQL_TYPE_STRING,
            t => {
                unimplemented!(
